    ...
    return(
        <div className="ContenedorPromos">
            ...
            <div className="Promos">
                <Producto nombre="Poke Salad" imagen={Tokyo} precio={499}></Producto>
                <Producto nombre="Kiri" imagen={Alaska} precio={499}></Producto>
                <Producto nombre="Poke Salad" imagen={Cooked} precio={499}></Producto>
            </div>
            <div className="Promos">
                <Producto nombre="Poke Salad" imagen={Black} precio={499}></Producto>
                <Producto nombre="Poke Salad" imagen={Bilbao} precio={499}></Producto>
                <Producto nombre="Poke Salad" imagen={PokeSalad} precio={499}></Producto>
            </div>
        </div>
    )
}
